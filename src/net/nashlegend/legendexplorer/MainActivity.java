...
import net.nashlegend.legendexplorer.adapter.FilePagerAdapter;
import net.nashlegend.legendexplorer.consts.FileConst;
import net.nashlegend.legendexplorer.fragment.BaseFragment;
import net.nashlegend.legendexplorer.fragment.BookMarksFragment;
import net.nashlegend.legendexplorer.fragment.CategoriedFragment;
import net.nashlegend.legendexplorer.fragment.FilesFragment;
import net.nashlegend.legendexplorer.utils.StorageObserver;
import net.nashlegend.legendexplorer.view.FolderViewPager;
